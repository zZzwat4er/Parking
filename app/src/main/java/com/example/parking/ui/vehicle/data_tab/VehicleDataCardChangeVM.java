...
public class VehicleDataCardChangeVM extends ViewModel {

    private Integer errCode;
    private MutableLiveData<ServerReqCodes> sOut;

    public VehicleDataCardChangeVM(){
    ...
    public void serverRequest(@NonNull final Activity activity, Integer catID, Integer mainCard, @Nullable Integer secondCard){
        comAPI.updateCards(
                AccountHolder.email,
